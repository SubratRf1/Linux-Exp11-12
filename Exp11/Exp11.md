 ...
 **Write a script that takes a sentence as input and splits it into individual words.**<br><br>


  ### Script:
   ![script1](images/1101.png)<br><br>

  ### Output:
   ![output1](images/1102.png)<br><br>

---------------------------------------------------------------------------
## <h1 style="background-color: pink;">TASK 2: String Palindrome Check</h1>
  **Create a script that checks whether a given string is a palindrome or not.** <br><br>


  ### Script:
   ![script2](images/1103.png)<br><br>

  ### Output:
   ![output2](images/1104.png)<br><br>
...
- The output in both scripts is displayed clearly and is easy to understand.
- Both programs work correctly for normal text input without special characters.
